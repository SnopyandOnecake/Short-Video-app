...
public class FragmentMyBindingImpl extends FragmentMyBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.card_overlap, 10);
        sViewsWithIds.put(R.id.user_feed, 11);
        sViewsWithIds.put(R.id.user_comment, 12);
        sViewsWithIds.put(R.id.user_favorite, 13);
        sViewsWithIds.put(R.id.user_history, 14);
    }
    // views
    @NonNull
